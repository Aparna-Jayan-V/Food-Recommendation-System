...
content_rec = pickle.load(open('content_recommendation.pkl','rb'))
content=list(content_rec)

recommended_item_ids = pickle.load(open('recommended_item_ids.pkl','rb'))
item_ids=list(recommended_item_ids)

data = pickle.load(open('data.pkl','rb'))
df_data=pd.DataFrame(data)

data_user = pickle.load(open('data_user.pkl','rb'))
